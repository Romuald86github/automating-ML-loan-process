...
def create_preprocessing_pipeline():
    ...
    preprocessing_pipeline = Pipeline([
        ('categorical_encoder', ColumnTransformer(
            transformers=[
                ('one_hot_encode', categorical_encoder, categorical_features)
            ],
    ...
    return preprocessing_pipeline, categorical_encoder

def preprocess_data():
    """Preprocess the loan data using the created pipeline."""
    cleaned_data = clean_data()
    preprocessing_pipeline, categorical_encoder = create_preprocessing_pipeline()
    ...
    return X_train, X_test, y_train, y_test, preprocessing_pipeline, categorical_encoder
